...
// function getExecutableDsl(liteGraphSpec: LiteGraphSpec): Children {
//     const topLambdaId = getSmallRandomId()
//     const lambdaOut: string[] = []

//     const portNodes: LiteGraphNode[] = []
...
//                 type: 'lambda_input',
//                 inputPortName: sourceNode.properties.name,
//                 value: ''
//             }
//         } else {
//             symbolMap[destinationId].inputs[destinationInput.name] = {
...
//         if (destinationNode.type === 'graph/output') {
//             lambdaOut.push(sourceId)
//         }
//     }

//     for (const symbolId in symbolMap) {
//         const symbol = symbolMap[symbolId]
//         if (symbol.type === 'graph/subgraph') {
//             if (nodeMap[symbolId].subgraph !== undefined)  {
//                 const children = getExecutableDsl(nodeMap[symbolId]!.subgraph)
//             }
//         }
//     }
